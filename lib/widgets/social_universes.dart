  ...
  Future<void> _startStarCaching(bool isDarkMode) async {
    ...
    Future.microtask(() async {
      try {
        ...
        await _cacheStarTypeWithGlow('middle', AppColors.lightPrimary, isDarkMode);
        await _cacheStarTypeWithGlow('middle_vip', AppColors.lightPrimary, isDarkMode);
    ...
    _starPaint
      ..shader = const LinearGradient(
        colors: [AppColors.vipGold, AppColors.warning],
                                      ...
                                      GestureDetector(
                                        ...
                                        child: Container(
                                          ...
                                          decoration: BoxDecoration(
                                            ...
                                            border: Border.all(color: AppColors.warning.withOpacity(0.8)),
                                          ),
                                          child: const Row(
                                            mainAxisSize: MainAxisSize.min,
                                            children: [
                                              Icon(Icons.psychology, size: 12, color: AppColors.warning),
                                              SizedBox(width: 4),
                                              Text(
                                                'TEST',
                                                style: TextStyle(
              ...
              Positioned(
                ...
                child: GestureDetector(
                  ...
                  child: Container(
                    ...
                    padding: const EdgeInsets.all(12),
                    decoration: BoxDecoration(
                      color: isDarkMode ? Colors.black.withOpacity(0.85) : Theme.of(context).colorScheme.outline.withOpacity(0.45),
              ...
              if (_showControls && _selectedContact == null)
                Positioned(
                  ...
                  child: Container(
                    ...
                    padding: const EdgeInsets.all(16),
                    decoration: BoxDecoration(
                      color: isDarkMode ? Colors.black.withOpacity(0.15) : Theme.of(context).colorScheme.outline.withOpacity(0.45),
                      borderRadius: BorderRadius.circular(16),
                      border: Border.all(color: isDarkMode ? Colors.white24 : Colors.blue.shade100),
                      boxShadow: [
                        BoxShadow(
      ...
      builder: (context) => AlertDialog(
        title: Row(
          children: [
            ...
            const SizedBox(width: 12),
            Expanded(
              child: Text(contact.name, style: TextStyle(color: Theme.of(context).colorScheme.onSurface, fontWeight: FontWeight.bold)),
            ),
          ],
        ),
            ...
            children: [
              ...
              _buildDetailSection('Social Universe Positioning', [
                ...
                _buildDetailRow('CDI Score', '${contact.cdi.toStringAsFixed(1)}/100',
                  contact.cdi >= 80 ? AppColors.success : 
                ...
                _buildDetailRow('Position Angle', '${contact.angleDeg.toStringAsFixed(1)}°',
                  Theme.of(context).colorScheme.onSurface, isDarkMode),
                _buildDetailRow('VIP Status', contact.isVIP ? 'YES' : 'NO',
                  contact.isVIP ? AppColors.vipGold : Theme.of(context).colorScheme.outline, isDarkMode),
              ...
              _buildDetailSection('Contact Information', [
                _buildDetailRow('Connection Type', contact.connectionType, Theme.of(context).colorScheme.onSurface, isDarkMode),
                _buildDetailRow('Period', contact.period, Theme.of(context).colorScheme.onSurface, isDarkMode),
                _buildDetailRow('Frequency', '${contact.frequency}/period', Theme.of(context).colorScheme.onSurface, isDarkMode),
                _buildDetailRow('Last Contacted', lastContactText, Theme.of(context).colorScheme.onSurface, isDarkMode),
                _buildDetailRow('Interaction Count', 
                  '${contact.interactionCountInWindow} in last 90 days', Theme.of(context).colorScheme.onSurface, isDarkMode),
              ], isDarkMode),
                ...
                Column(
                  ...
                  children: [
                    Text(
                      'Tags:',
                      style: TextStyle(
                        color: isDarkMode ? Colors.white70 : Theme.of(context).colorScheme.outline,
                        fontWeight: FontWeight.bold,
                      ),
                    ),
                    const SizedBox(height: 4),
                    Wrap(
                      ...
                      children: contact.tags.map((tag) => Container(
                        ...
                        decoration: BoxDecoration(
                          color: isDarkMode ? Colors.white.withOpacity(0.1) : Theme.of(context).colorScheme.outline,
                          borderRadius: BorderRadius.circular(12),
                        ),
                        child: Text(
                          tag,
              ...
              Container(
                padding: const EdgeInsets.all(12),
                decoration: BoxDecoration(
                  color: isDarkMode ? Colors.white.withOpacity(0.05) : Theme.of(context).colorScheme.outline,
                  borderRadius: BorderRadius.circular(16),
        ...
        children: [
          SizedBox(
            ...
            child: Text(
              '$label:',
              style: TextStyle(
                color: isDarkMode ? Colors.white70 : Theme.of(context).colorScheme.surfaceContainerLow,
                fontSize: 12,
              ),
            ),
          ),
      ...
      return Container(
        ...
        decoration: BoxDecoration(
          ...
          gradient: LinearGradient(
            ...
            colors: [
              AppColors.vipGold.withOpacity(0.6),
                    ...
                    decoration: BoxDecoration(
                      ...
                      gradient: LinearGradient(
                        colors: _useMockData && contact.id.startsWith('mock_') 
                          ? [AppColors.warning, Color(0xFFFF9800)]
...
class UniversePainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    _drawRing(
      ...
      innerRingOuter,
      isDarkMode 
        ? AppColors.vipGold.withOpacity(0.15 + 0.3 * immersionLevel)
        : AppColors.vipGold.withOpacity(0.12 + 0.25 * immersionLevel),
      isDarkMode,
      true
    );
  ...
  StarInfo? _drawStar(Canvas canvas, Offset center, Contact contact, double maxRadius, Size size, bool isDarkMode) {
    ...
    switch (determinedRing) {
      case 'inner':
        ...
        break;
      case 'middle':
        color = AppColors.lightPrimary; // Blue
        break;
      case 'outer':
  ...
  Color _getRingColor(String ring) {
    switch (ring) {
      ...
      case 'outer':
        return const Color(0xff897ED6);
      default:
        return Theme.of(navigatorKey.currentContext!).colorScheme.outline;
    }
  }
